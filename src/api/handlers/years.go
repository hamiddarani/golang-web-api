...
// @Accept json
// @produces json
// @Param Request body dtos.CreatePersianYearRequest true "Create a PersianYear"
// @Success 201 {object} helper.BaseHttpResponse{result=dtos.PersianYearResponse} "PersianYear response"
...
// @Param Request body dtos.UpdatePersianYearRequest true "Update a PersianYear"
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PersianYearResponse} "PersianYear response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PagedList[dtos.PersianYearResponse]} "PersianYear response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
