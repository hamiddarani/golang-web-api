...
// @Accept json
// @produces json
// @Param Request body dtos.CreateCarModelColorRequest true "Create a CarModelColor"
// @Success 201 {object} helper.BaseHttpResponse{result=dtos.CarModelColorResponse} "CarModelColor response"
...
// @Param Request body dtos.UpdateCarModelColorRequest true "Update a CarModelColor"
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.CarModelColorResponse} "CarModelColor response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PagedList[dtos.CarModelColorResponse]} "CarModelColor response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
