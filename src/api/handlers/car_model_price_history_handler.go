...
// @Accept json
// @produces json
// @Param Request body dtoss.CreateCarModelPriceHistoryRequest true "Create a CarModelPriceHistory"
// @Success 201 {object} helper.BaseHttpResponse{result=dtoss.CarModelPriceHistoryResponse} "CarModelPriceHistory response"
...
// @Param Request body dtoss.UpdateCarModelPriceHistoryRequest true "Update a CarModelPriceHistory"
// @Success 200 {object} helper.BaseHttpResponse{result=dtoss.CarModelPriceHistoryResponse} "CarModelPriceHistory response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Accept json
// @produces json
// @Param Request body dtoss.PaginationInputWithFilter true "Request"
// @Success 200 {object} helper.BaseHttpResponse{result=dtoss.PagedList[dtoss.CarModelPriceHistoryResponse]} "CarModelPriceHistory response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
