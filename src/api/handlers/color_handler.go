...
// @Accept json
// @produces json
// @Param Request body dtos.CreateColorRequest true "Create a Color"
// @Success 201 {object} helper.BaseHttpResponse{result=dtos.ColorResponse} "Color response"
...
// @Param Request body dtos.UpdateColorRequest true "Update a Color"
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.ColorResponse} "Color response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PagedList[dtos.ColorResponse]} "Color response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
