...
// @Accept json
// @produces json
// @Param Request body dtos.CreateCarTypeRequest true "Create a CarType"
// @Success 201 {object} helper.BaseHttpResponse{result=dtos.CarTypeResponse} "CarType response"
...
// @Param Request body dtos.UpdateCarTypeRequest true "Update a CarType"
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.CarTypeResponse} "CarType response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PagedList[dtos.CarTypeResponse]} "CarType response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
