...
// @Accept json
// @produces json
// @Param Request body dtos.CreatePropertyRequest true "Create a Property"
// @Success 201 {object} helper.BaseHttpResponse{result=dtos.PropertyResponse} "Property response"
...
// @Param Request body dtos.UpdatePropertyRequest true "Update a Property"
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PropertyResponse} "Property response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dtos.PagedList[dtos.PropertyResponse]} "Property response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
